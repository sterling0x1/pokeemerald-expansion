...
static const u32 gCredits_Gfx[] = INCGFX_U32("graphics/blackjack/digits.png", ".4bpp.smol");
static const u16 sCredit_Pal[] = INCGFX_U16("graphics/blackjack/digits.pal", ".gbapal");
...
static const u32 gOption_3_Gfx[] = INCGFX_U32("graphics/blackjack/option_3.png", ".4bpp.smol");
